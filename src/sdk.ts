...
export const NonFungibleTokenMintInfoFragmentDoc = gql`
  ...
  mintTransaction {
    ...
    methodId
    status
    logs @include(if: $includeMintTransactionLogs) {
      data
      logIndex
      removed
      topics
...
export const AddressDocument = gql`
    query address($address: String!, $tokensLimit: Int = 10, $includeProfile: Boolean = false, $includeReverseProfile: Boolean = false, $includeTokens: Boolean = false, $includeTokenUri: Boolean = false, $includeMintInfo: Boolean = false, $includeMediaInfo: Boolean = false, $includeMintTransactionLogs: Boolean = false, $includeSales: Boolean = false, $includeMakerReverseProfile: Boolean = false, $includeTakerReverseProfile: Boolean = false) {
...
export const TokenDocument = gql`
    query token($contract: String!, $tokenId: String!, $includeOwnerInfo: Boolean = false, $includeOwnerProfile: Boolean = false, $includeOwnerReverseProfile: Boolean = false, $includeTokenUri: Boolean = false, $includeMintInfo: Boolean = false, $includeMediaInfo: Boolean = false, $includeMintTransactionLogs: Boolean = false, $includeSales: Boolean = false, $includeMakerReverseProfile: Boolean = false, $includeTakerReverseProfile: Boolean = false) {
...
export const TokensDocument = gql`
    query tokens($filter: TokensFilter, $limit: Int = 50, $before: String, $after: String, $includeTotalCount: Boolean = false, $includeOwnerInfo: Boolean = false, $includeOwnerProfile: Boolean = false, $includeOwnerReverseProfile: Boolean = false, $includeTokenUri: Boolean = false, $includeMintInfo: Boolean = false, $includeMediaInfo: Boolean = false, $includeMintTransactionLogs: Boolean = false, $includeSales: Boolean = false, $includeMakerReverseProfile: Boolean = false, $includeTakerReverseProfile: Boolean = false) {
...
export type AddressQueryVariables = Exact<{
  ...
  includeMintTransactionLogs?: InputMaybe<Scalars['Boolean']>;
...
export type AddressQuery = { address: { address: any, profile?: { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null } | null, reverseProfile?: { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null } | null, tokens?: Array<{ tokenUri?: any | null, contract: string, description: string | null, name: string | null, tokenId: string, externalUrl: string | null, imageStorageType: TokenStorageType | null, backgroundColor: string | null, youtubeUrl: string | null, mintPrice: any, animation: { blurhash: string | null, checksum: string, height: number | null, width: number | null, url: string | null, smallUrl: string | null, thumbnailUrl: string | null, largeUrl: string | null, mimeType: string | null } | null, image: { blurhash: string | null, checksum: string, height: number | null, width: number | null, url: string | null, smallUrl: string | null, thumbnailUrl: string | null, largeUrl: string | null, mimeType: string | null } | null, sales: Array<{ eventIndex: number, logIndex: number, marketplace: Marketplace, price: any, currencyContract: { address: any } | null, maker: { address: any, reverseProfile?: { name: string, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null } | null }, marketplaceContract: { address: any }, taker: { address: any, reverseProfile?: { name: string, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null } | null } }> | null, mintTransaction: { blockNumber: number, blockTimestamp: any, effectiveGasPrice: any, gas: number, gasPaid: any, gasUsed: number, gasPrice: any, hash: string, id: string, index: number, input: string | null, value: any, methodId: string | null, status: boolean, events: Array<{ transactionHash: string } | { transactionHash: string }>, logs?: Array<{ data: string, logIndex: number, removed: boolean, topics: Array<string> }> } | null }> | null } | null };
...
export type TokenQuery = { token: { tokenUri?: any | null, contract: string, description: string | null, name: string | null, tokenId: string, externalUrl: string | null, imageStorageType: TokenStorageType | null, backgroundColor: string | null, youtubeUrl: string | null, mintPrice: any, owner: { address: any, profile?: { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null } | null, reverseProfile?: { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null } | null } | null, animation: { blurhash: string | null, checksum: string, height: number | null, width: number | null, url: string | null, smallUrl: string | null, thumbnailUrl: string | null, largeUrl: string | null, mimeType: string | null } | null, image: { blurhash: string | null, checksum: string, height: number | null, width: number | null, url: string | null, smallUrl: string | null, thumbnailUrl: string | null, largeUrl: string | null, mimeType: string | null } | null, sales: Array<{ eventIndex: number, logIndex: number, marketplace: Marketplace, price: any, currencyContract: { address: any } | null, maker: { address: any, reverseProfile?: { name: string, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null } | null }, marketplaceContract: { address: any }, taker: { address: any, reverseProfile?: { name: string, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null } | null } }> | null, mintTransaction: { blockNumber: number, blockTimestamp: any, effectiveGasPrice: any, gas: number, gasPaid: any, gasUsed: number, gasPrice: any, hash: string, id: string, index: number, input: string | null, value: any, methodId: string | null, status: boolean, events: Array<{ transactionHash: string } | { transactionHash: string }>, logs?: Array<{ data: string, logIndex: number, removed: boolean, topics: Array<string> }> } | null } | null };
...
export type TokensQuery = { tokens: { totalCount?: number, cursors: { before: string | null, after: string | null }, tokens: Array<{ tokenUri?: any | null, contract: string, description: string | null, name: string | null, tokenId: string, externalUrl: string | null, imageStorageType: TokenStorageType | null, backgroundColor: string | null, youtubeUrl: string | null, mintPrice: any, owner: { address: any, profile?: { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null } | null, reverseProfile?: { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null } | null } | null, animation: { blurhash: string | null, checksum: string, height: number | null, width: number | null, url: string | null, smallUrl: string | null, thumbnailUrl: string | null, largeUrl: string | null, mimeType: string | null } | null, image: { blurhash: string | null, checksum: string, height: number | null, width: number | null, url: string | null, smallUrl: string | null, thumbnailUrl: string | null, largeUrl: string | null, mimeType: string | null } | null, sales: Array<{ eventIndex: number, logIndex: number, marketplace: Marketplace, price: any, currencyContract: { address: any } | null, maker: { address: any, reverseProfile?: { name: string, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null } | null }, marketplaceContract: { address: any }, taker: { address: any, reverseProfile?: { name: string, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null } | null } }> | null, mintTransaction: { blockNumber: number, blockTimestamp: any, effectiveGasPrice: any, gas: number, gasPaid: any, gasUsed: number, gasPrice: any, hash: string, id: string, index: number, input: string | null, value: any, methodId: string | null, status: boolean, events: Array<{ transactionHash: string } | { transactionHash: string }>, logs?: Array<{ data: string, logIndex: number, removed: boolean, topics: Array<string> }> } | null }> } };

export type NonFungibleTokenMintInfoFragment = { mintPrice: any, mintTransaction: { blockNumber: number, blockTimestamp: any, effectiveGasPrice: any, gas: number, gasPaid: any, gasUsed: number, gasPrice: any, hash: string, id: string, index: number, input: string | null, value: any, methodId: string | null, status: boolean, events: Array<{ transactionHash: string } | { transactionHash: string }>, logs?: Array<{ data: string, logIndex: number, removed: boolean, topics: Array<string> }> } | null };

export type NonFungibleTokenSaleInfoFragment = { sales: Array<{ eventIndex: number, logIndex: number, marketplace: Marketplace, price: any, currencyContract: { address: any } | null, maker: { address: any, reverseProfile?: { name: string, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null } | null }, marketplaceContract: { address: any }, taker: { address: any, reverseProfile?: { name: string, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null } | null } }> | null };

export type NonFungibleTokenOwnerInfoFragment = { owner: { address: any, profile?: { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null } | null, reverseProfile?: { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null, github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null } | null } | null };
...
export type CommonServiceKeysFragment = { github: string | null, peepeth: string | null, linkedin: string | null, twitter: string | null, keybase: string | null, telegram: string | null };

export type GlobalKeysFragment = { name: string, avatar: string | null, description: string | null, display: string | null, email: string | null, keywords: string | null, mail: string | null, notice: string | null, location: string | null, phone: string | null, url: string | null };
