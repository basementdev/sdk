...
export type Erc20Transfer = TransactionEvent &
  Transfer & {
...
export function getSdk(
  ...
  return {
    ...
    erc721Transfers(
      variables?: Erc721TransfersQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<Erc721TransfersQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Erc721TransfersQuery>(
            Erc721TransfersDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "erc721Transfers",
    ...
    erc20Transfers(
      variables?: Erc20TransfersQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<Erc20TransfersQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Erc20TransfersQuery>(
            Erc20TransfersDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "erc20Transfers",
    ...
    erc20Balances(
      variables: Erc20BalancesQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<Erc20BalancesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<Erc20BalancesQuery>(Erc20BalancesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "erc20Balances",
...
export type Erc721TransfersQuery = {
  erc721Transfers: {
    totalCount?: number;
    cursors: { before: string | null; after: string | null };
...
export type Erc20TransfersQuery = {
  erc20Transfers: {
    totalCount?: number;
    cursors: { before: string | null; after: string | null };
...
export type Erc20BalancesQuery = {
  erc20Balances: Array<{
    amount: any;
...
export type NonFungibleTokenAttributesFragment = {
  attributes: Array<{
    displayType: string | null;
    traitType: string | null;
    value: string | null;
