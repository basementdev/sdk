...
| `include.logs`                | `bool`           | If `true`, the profile information will be included, if available.                                                                                                               |
...
| Name                                       | Type     | Default | Description                                                                                                                                                                      |
| ------------------------------------------ | -------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `filter.blockNumbers`                      | `string` |         | Filter tokens that satisfy the given contract address.                                                                                                                           |
| `filter.contractAddresses`                 | `string` |         | Filter tokens that satisfy the given contract address.                                                                                                                           |
| `filter.fromAddresses`                     | `string` |         | Filter tokens that satisfy the given contract address.                                                                                                                           |
| `filter.toAddresses`                       | `string` |         | Filter tokens that satisfy the given contract address.                                                                                                                           |
| `filter.tokenIds`                          | `string` |         | Filter tokens that satisfy the given contract address.                                                                                                                           |
| `filter.exclude`                           | `string` |         | Filter tokens that satisfy the given contract address.                                                                                                                           |
| `limit`                                    | `number` | 10      | Maximum number of token transfers to return.                                                                                                                                     |
| `include.totalCount`                       | `bool`   | `false` | If `true`, it will include ERC721, like `tokenId`, `attributes`, `contractAddress`, etc.                                                                                         |
| `include.contract`                         | `bool`   | `false` | If `true`, it will include ERC721, like `tokenId`, `attributes`, `contractAddress`, etc.                                                                                         |
| `include.contract.reverseProfile`          | `bool`   | `false` | If `true`, it will include ERC721, like `tokenId`, `attributes`, `contractAddress`, etc.                                                                                         |
